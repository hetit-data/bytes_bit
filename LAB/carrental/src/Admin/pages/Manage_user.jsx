                                ...
                                return (
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-center'>
                                            <MDBBtn onClick={() => viewdata(data)} color='link' rounded size='sm'>
                                                view
                                            </MDBBtn>
                                            <MDBBtn onClick={() => updatedata(data.id)} color='link' rounded size='sm'>
                                                edit
                                            </MDBBtn>
                                            <MDBBtn onClick={() => deletedata(data.id)} color='link' rounded size='sm'>
                                                delete
                                            </MDBBtn>
                                        </td>
                                    </tr>
